...
'容易にできることのたとえを、「何の手をひねる」という?': '赤子', 'スポーツブランドフレッド・ペリーのマークに描かれている植物は？': '月桂樹', 
...
'バイオリンの名曲「G線上のアリア」の作曲者は誰?': 'バッハ', '「ダイナマイト」の語源となった言葉の意味はどれ?': '力', 　
...
'中国で問題になっている小胖子といったらどんな人のこと？': '太り過ぎの子', '杉浦日向子の漫画百日紅で描かれている江戸時代の有名な浮世絵師は？': '葛飾北斎', '世界遺産にも登録されている姫路城がある県はどこ?': '兵庫県', 'プロレスラー・大谷晋二郎が持っているプロレスの教科書の１ページ目に載っている言葉は何？': '生涯志高く、今が奇跡なり！', '日本人選手がオリンピックで初めて金メダルを獲得した競技はどれ?': '陸上'}}
