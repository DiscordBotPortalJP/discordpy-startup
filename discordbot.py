...
async def on_member_join(member):
   await client.get_channel(553825840241311775).send(f'ようこそ、{member.mention} さん！あなたの訪問を歓迎させていただきます、FLナビゲーションbotの翠と申します！ まずは #サーバー説明・ルール を見ることをオススメしますよ！楽しんでくださいね！')
