...
async def on_member_join(member):
	...
	#雑談チャンネルで発言　多分ニックネームは入った瞬間は付いていないからnameだけでいい
	await bot.get_channel(798189252080435231).send(f"{member.name}さんはじめまして！お暇なときに<#798192857327992882>を一読しておいてくださいね！")
